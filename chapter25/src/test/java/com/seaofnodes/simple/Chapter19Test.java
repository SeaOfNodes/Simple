...
""";
        ...
        assertEquals("Stop[ return MEM[ 2:___ 3:___ 4:.cs=(*[~]u8)Bot; 5:._hashCode=0;]; return Phi(Region,0,1,1,0); return Phi(Region,._hashCode,Phi(Region,123456789,Phi(Loop,0,(.[]+((Phi_hash<<5)-Phi_hash))))); return #2; ]", code._stop.toString());
