...
public class StoreARM extends MemOpARM {
    ...
    private int imm_op() {
        return declType() == TypeFloat.F32 ? arm.OPF_STORE_IMM_32
            :  declType() == TypeFloat.F64 ? arm.OPF_STORE_IMM_64
            :  OP_STORES[declType().log_size()];
    }
    ...
    @Override public void encoding( Encoding enc ) {
        ldst_encode(enc, imm_op(), OP_STORE_RS[declType().log_size()], val(), size());
    }
