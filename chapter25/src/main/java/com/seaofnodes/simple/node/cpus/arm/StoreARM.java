...
public class StoreARM extends MemOpARM {
    ...
    private int imm_op() {
        return _con == TypeFloat.F32 ? arm.OPF_STORE_IMM_32
            :  _con == TypeFloat.F64 ? arm.OPF_STORE_IMM_64
            :  OP_STORES[_con.log_size()];
    }
    ...
    @Override public void encoding( Encoding enc ) {
        ldst_encode(enc, imm_op(), OP_STORE_RS[_con.log_size()], val(), size());
    }
