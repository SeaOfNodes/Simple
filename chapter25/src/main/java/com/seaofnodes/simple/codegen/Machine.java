...
abstract public class Machine {
    ...
    // The FunNode holds the stack layout after RegAlloc, which in turn
    // dictates the stack slot (the frame offset) for stack splits.
    public abstract SplitNode split( LRG lrg, String kind, byte round );
