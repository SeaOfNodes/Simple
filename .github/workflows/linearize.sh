...
while read -r chapter; do
  ...
  root_files=(README.md LICENSE pom.xml .gitignore .dir-locals.el transpile-tests graph build-support)
  author_root_files=()
  ...
  root_files=(LICENSE .gitignore .dir-locals.el transpile-tests graph build-support)
