...
public interface MachNode {
  // Registers are limited to 64, and represented as a bitmask in a "long".

  // Register mask allowed on input i.  0 for no register.
  abstract public long regmap(int i);
  // Register mask allowed as a result.  0 for no register.
  abstract public long outregmap();
  // Multi-reg-defining machine op; idx comes from Proj.
  // Sometimes these Projs have no uses, and just exist to kill a register.
  default long outregmap(int idx) { throw Utils.TODO(); }
