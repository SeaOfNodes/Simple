...
import com.seaofnodes.simple.node.AddFNode;
import com.seaofnodes.simple.node.LoadNode;
import com.seaofnodes.simple.node.Node;
import com.seaofnodes.simple.node.cpus.x86_64_v2.x86_64_v2;

public class AddFMemRISC extends MemOpRISC{

    AddFMemRISC(AddFNode add, LoadNode ld , Node base, Node idx, int off, int scale, Node val ) {
    ...
    @Override public RegMask regmap(int i) {
        ...
        if( i==4 ) return riscv.FMASK;  // value
        throw Utils.TODO();
    }
