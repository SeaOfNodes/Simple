...
public class DivFIX86 extends MachConcreteNode implements MachNode {
    TypeFloat _tf;
    DivFIX86(Node add, TypeFloat tf) { super(add);  _inputs.pop(); _tf = tf; }
    ...
    // General form: "divss  | divsd  dst /= src"
