...
/** Zero-code machine form of {@link PtrToIntNode}. */
public class PtrToIntMach extends PtrToIntNode implements MachNode {
    public PtrToIntMach(PtrToIntNode ptr) { super(ptr); }
