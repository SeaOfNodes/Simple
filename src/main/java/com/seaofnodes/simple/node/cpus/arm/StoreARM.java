...
public class StoreARM extends MemOpARM {
    ...
    private int imm_op() {
        return val()!=null && val()._type instanceof TypeFloat
            ? (_bytes==4 ? arm.OPF_STORE_IMM_32 : arm.OPF_STORE_IMM_64)
            : OP_STORES[Integer.numberOfTrailingZeros(_bytes)];
    }
    ...
    @Override public void encoding( Encoding enc ) {
        ldst_encode(enc, imm_op(), OP_STORE_RS[Integer.numberOfTrailingZeros(_bytes)], val(), size());
    }
